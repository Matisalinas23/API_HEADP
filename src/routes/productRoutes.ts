...
router.put('/update_image/:id', authMiddleware, upload.single("image"), updateProductImage)
router.put('/update_categories/:id', authMiddleware, updatedCategoriesProduct)
